...
./bin/strongforced add-genesis-account $(./bin/strongforcecli keys show A -a) 10000strong,100000000stake
./bin/strongforced add-genesis-account $(./bin/strongforcecli keys show B -a) 10000strong,100000000stake
